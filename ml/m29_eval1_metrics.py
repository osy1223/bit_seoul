...
model.fit(x_train, y_train, 
    ...
    eval_set =[(x_train,y_train),(x_test, y_test)] #평가는 x_test, y_test & 지표는 RMSE
    #출력은 n_estimators만큼
)
...
'''
[9999]  validation_0-rmse:0.00147       validation_0-mae:0.00105        validation_1-rmse:2.63822       validation_1-mae:1.98226
r2 : 0.9039005810073445
'''